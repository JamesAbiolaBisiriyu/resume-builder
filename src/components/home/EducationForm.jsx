// File Purpose: Home and resume-builder UI section component: EducationForm.
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={() => addEducation()} // Added missing function call
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-3">
                ...
                <input
                  ...
                  type="text"
                  placeholder="Degree's (e.g., Bachelor's, Masters) "
                  className="px-3 py-2
                text-sm "
                />
